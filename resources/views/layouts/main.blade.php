        ...
        <div class="layout-container">
          ...
          <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
              ...
              <!-- Tables -->
              <li class="menu-item {{ Request::routeIs('data-artikel') ? 'active' : '' }}">
                <a href="{{ Route('data-artikel') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bxs-book-content"></i>
                  <div data-i18n="Tables">Artikel</div>
                </a>
              </li>
              <li class="menu-item {{ Request::routeIs('lapora-artikel') ? 'active' : ''}}">
                <a href="{{ Route('laporan-artikel') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bxs-report"></i>
                  <div data-i18n="Tables">Laporan Artikel</div>
                </a>
              </li>
